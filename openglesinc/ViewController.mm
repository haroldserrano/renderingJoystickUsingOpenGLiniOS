...
- (void)viewDidLoad
{
    ...
    buttonA=new Button(680,740,100.0,100.0,"ButtonA.png","ButtonAPressed.png",self.view.bounds.size.height,self.view.bounds.size.width);
    ...
    buttonB=new Button(680,840,100.0,100.0,"ButtonB.png","ButtonBPressed.png",self.view.bounds.size.height,self.view.bounds.size.width);
    ...
    joystick=new Joystick(80,800,"joyStickBackground.png",100,100,"joystickDriver.png",60,60,self.view.bounds.size.height,self.view.bounds.size.width);
...
- (void)update
{
    ...
    if (touchBegan==true) {
        ...
        //6.test if the touch falls within the coordinates of the joystick
        if(joystick->getJoystickIsPress()==true){
            
            //7. update the character to rotate
            
            character->update(joystick->getDisplacementInXDirection(), joystick->getDisplacementInYDirection());
        ...
        //8. reset the position of the joystick driver
